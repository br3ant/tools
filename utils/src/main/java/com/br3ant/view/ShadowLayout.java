...
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mCornerRadius = attr.getDimension(R.styleable.ShadowLayout_hl_cornerRadius, 5);
            ...
            mShadowColor = attr.getColor(R.styleable.ShadowLayout_hl_shadowColor, Color.parseColor("#1A000000"));
        } finally {
            attr.recycle();
        }
    }
